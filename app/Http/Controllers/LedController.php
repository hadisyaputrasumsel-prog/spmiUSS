...
class LedController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (in_array($user->role->kode, ['super_admin', 'lpma', 'auditor'])) {
            if ($unit_id && $unit_id != 'all' && $unit_id != -1) {
                ...
                $standardsQuery = Standard::whereNull('sasaran_unit')
        ...
        return view('led.index', compact('standards', 'tahun', 'unit_id', 'status'));
    }
    ...
    public function edit(Request $request, $kode)
    {
        ...
        return view('led.edit', compact('standard', 'entry', 'stageData', 'tahun', 'unit_id'));
    }
